...
│       ├── auth_rs256.py (8KB)
│       ├── consent.py (7KB)
│       ├── consent_rs256.py (10KB)
│       ├── envelope.py (16KB) - EventEnvelope model
│       ├── http_client.py (5KB)
│       ├── http_client_tracing.py (7KB)
│       ├── idempotency.py (12KB)
│       ├── idempotency_middleware.py (9KB)
│       ├── logging.py (351B)
│       ├── monitoring.py (12KB)
│       ├── performance.py (12KB)
│       ├── replay_endpoints.py (11KB)
│       ├── replay_store.py (20KB)
│       ├── schema_validation.py (13KB)
│       ├── tracing.py (14KB)
│       └── tracing_middleware.py (6KB)
├── schemas/
│   └── event-envelope.json (4KB)
├── tests/ (17 test files)
├── pyproject.toml
├── README.md
├── PUBLISHING.md
...
├── test_consent_messages.py
├── test_monitoring_messages.py

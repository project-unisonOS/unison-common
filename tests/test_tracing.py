"""
pytest tests for unison-common tracing module
"""
...
class TestCorrelationMiddleware:
    ...
    def test_correlation_id_extraction(self):
        ...
        # Test with no correlation ID - should generate new one
...
class TestGlobalTracer:
    ...
    def test_global_tracer_initialization(self):
